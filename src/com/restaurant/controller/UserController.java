...
public class UserController extends HttpServlet {
	...
	private static String INSERT_OR_EDIT = "/WEB-INF/user.jsp";
	private static String LIST_USER = "/WEB-INF/userList.jsp";
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (user != null) {
			...
			response.sendRedirect(request.getContextPath() + "/loginPage.jsp?error=" + wrongNameOrPass);
		}
